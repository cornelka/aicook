...
sys.path.append('src') #Pieter

from src import model, sample, encoder # pieter
from load_dataset import load_dataset, Sampler # pieter
...
parser.add_argument('--model_name', metavar='MODEL', type=str, default='124M', help='Pretrained model name') # 124M
...
parser.add_argument('--sample_every', metavar='N', type=int, default=1, help='Generate samples every N steps') # P default=100
parser.add_argument('--sample_length', metavar='TOKENS', type=int, default=50, help='Sample this many tokens') # 1023
parser.add_argument('--sample_num', metavar='N', type=int, default=1, help='Generate this many samples')
parser.add_argument('--save_every', metavar='N', type=int, default=10, help='Write a checkpoint every N steps') # 1000
...
"""""" # changing back to parent folder after having imported the module to be able to use function properly
