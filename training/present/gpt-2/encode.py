...
parser.add_argument('--model_name', metavar='MODEL', type=str, default='124M', help='Pretrained model name') #default='117M'
...
def main():
    ...
    print('Reading files')
    chunks = load_dataset.load_dataset(enc, args.in_text, args.combine, encoding=args.encoding)
